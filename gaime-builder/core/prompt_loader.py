"""
Prompt Loader - Loads prompts from text files.

Copied and adapted from backend/app/llm/prompt_loader.py for TUI independence.
"""
...
class PromptLoader:
    ...
    def __init__(self, prompts_dir: Optional[Path] = None):
        ...
        if prompts_dir is None:
            # Default to backend prompts (shared with web UI)
            project_root = Path(__file__).parent.parent.parent
            prompts_dir = project_root / "backend" / "app" / "llm" / "prompts"
