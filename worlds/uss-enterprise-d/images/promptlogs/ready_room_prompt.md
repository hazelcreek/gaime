# Image Prompt: Captain's Ready Room
...
Scene Description:
Warm wood tones and quiet order. Books — real books — are shelved with care. A small desk sits beneath soft lighting, and a cup of tea waits with the patience of habit. This is not a place of authority so much as reflection: the calm that makes ethical action possible.

Interactive Elements to Include:
Visible pathways: a passage or doorway visible to the left side of the scene
Objects in the scene: Earl Grey Tea sits steaming on a coaster beside the desk, the scent subtle and grounding
