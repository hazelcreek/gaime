...
Scene Description:
Clean, bright, and quietly reassuring. The biobeds and monitors look clinical, but the human energy here is gentle: care as a discipline. The ship’s instability reaches even this far — a minor fluctuation in the lights — but Sickbay’s calm is a kind of shield.

Interactive Elements to Include:
Subtle environmental details: a faint draft or subtle irregularity in the wall suggesting something hidden
Objects in the scene: Hypospray rests on a sterilized tray beside a biobed, ready for immediate use
