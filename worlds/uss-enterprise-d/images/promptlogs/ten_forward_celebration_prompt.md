# Image Prompt: Ten Forward (Celebration)
...
Location: Ten Forward (Celebration)

Scene Description:
The same room, but changed by context. The ship's hum is steady again, and the crew's posture has shifted from problem-solving to togetherness. A corner table has been claimed for an impromptu celebration — small, sincere, and unmistakably Starfleet: pride in the work, gratitude for each other, and the quiet belief that doing the right thing matters.

Interactive Elements to Include:
Visible pathways: a passage or doorway visible to the left side of the scene
Characters visible in the scene:

- Guinan (Bartender and confidante; offers perspective beyond rank), stands near the claimed table, offering warmth without making the moment about herself: Poised and observant, with a calm that feels older than the ship. She watches people the way a navigator watches a star — not because she controls them, but because she understands their trajectories. Her presence makes honesty feel possible.
