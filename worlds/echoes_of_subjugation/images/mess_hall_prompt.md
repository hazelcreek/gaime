# Image Prompt: Nutrient Dispensary

Create a dramatic, atmospheric scene illustration for a text adventure game.

Location: Nutrient Dispensary
Theme: Sci-Fi Dystopia
Tone: Oppressive, Desperate, Synthetic

Scene Description:
A cavernous room lit by flickering halogen strips. Rows of metal tables are bolted to the floor. A large screen on the wall plays endless propaganda about the Protectors' mercy. The dispensing machines grind loudly.

Interactive Elements to Include:
Visible pathways: an opening or exit behind, perhaps suggested by light or shadows; a passage or doorway visible to the right side of the scene; a passage or doorway visible to the left side of the scene
Characters visible in the scene: A figure - Unit 88, Collaborator Android, stands at the dispensing station with an unsettling smile, mechanically distributing grey paste to a queue of hollow-eyed inmates
