# Image Prompt: Boone's Stash Room
...
Location: Boone's Stash Room

Scene Description:
A small storage room hastily converted into a planning office. To the east, the door leads back to the noisy balcony overlooking the saloon below.
Maps of railroad lines cover every wall, pinned with knives and marked with red ink. A small desk is covered in papers and telegrams. Crates of stolen goods are stacked in the corners - payroll strongboxes and Wells Fargo bags.
A kerosene lamp on the desk casts a warm circle of light. The single window is shuttered tight. Train schedules, bank notes, and routing maps reveal the scope of the gang's plans.

Scene Elements to Include:
- Railroad Maps: Detailed diagrams of the Union Pacific route.
- Visible pathway to the right: The door leading back to the noisy balcony, leading to Saloon Balcony
- Stolen Train Schedule is pinned to the wall with a knife
...
Composition: first-person perspective, extreme wide establishing shots or dramatic medium close-ups emphasizing eyes from eye level or low angle looking up for dramatic tension, occasional extreme close-ups. film grain, dust particles suspended in air, heat haze on horizons, lens flare from harsh sun, slight color desaturation, vignette

Critical constraints - the image must NOT include:
- modern or contemporary elements
- lush green landscapes or vegetation
- anime, cartoon, or stylized illustration
- dark gothic or horror lighting
- futuristic or science fiction
- clean, polished, or pristine surfaces
- rainy, wet, or overcast weather
- bright saturated colors
- soft romantic lighting
- American Hollywood Western glamour
- watermarks or signatures
- blurry or low-quality artifacts
- anachronistic elements (cars, electricity, modern clothing)
- green grass or lush vegetation
- cold blue or purple lighting
- pristine or new-looking objects
- clean-shaven, well-groomed characters
