...
Location: Muddy Alley

Scene Description:
A narrow strip of mud and broken bottles between the Saloon and the bank. It reeks of refuse. A ladder leads up to the Saloon's balcony, but the bottom rungs are missing.

Interactive Elements to Include:
Visible pathways: a passage or doorway visible to the left side of the scene; stairs leading upward, or a visible upper level or balcony
Objects in the scene: Wooden Crate sits overturned near the wall beneath the ladder
