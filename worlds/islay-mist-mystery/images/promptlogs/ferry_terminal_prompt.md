...
Scene Description:
The end of the line. The concrete pier juts out into the rough sea. The ferry lights are visible in the distance, approaching fast. This is where it ends.

Interactive Elements to Include:
Visible pathways: a doorway or passage visible ahead in the distance
Characters visible in the scene:

- Gordon MacNeil, The Victim's Brother, Standing near the bollards, suitcase in hand, looking at the horizon.
