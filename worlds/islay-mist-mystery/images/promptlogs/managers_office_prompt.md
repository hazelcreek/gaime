...
Scene Description:
Cluttered and chaotic. Papers are strewn everywhere. A large service elevator door is set into the back wall, currently shut tight. A framed photo sits on the desk.

Interactive Elements to Include:
Visible pathways: a passage or doorway visible to the left side of the scene
Objects in the scene: Framed Photograph Sitting prominently on the mahogany desk.
Characters visible in the scene:

- Fiona Campbell, Distillery Manager, Sitting behind the desk, looking defiant.
