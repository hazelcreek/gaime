...
Scene Description:
A hidden chamber used for centuries to hide illicit goods. Rotting barrels and crates are piled high. It's eerily quiet here, protected from the storm.

Interactive Elements to Include:
Visible pathways: an opening or exit behind, perhaps suggested by light or shadows
Objects in the scene: 1902 Whisky Tucked behind a false brick in the wall.; Smuggler's Ledger Resting on top of a dry barrel.
