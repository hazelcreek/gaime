...
Future style presets to consider creating. Each includes a brief description of the visual aesthetic.
...
| **Pre-Raphaelite** | Lush medieval romanticism, rich jewel tones, flowing hair, Rossetti/Waterhouse |
| **Impressionism** | Monet/Renoir—dappled light, visible brushstrokes, outdoor scenes, fleeting moments |
| **Surrealism** | Dalí/Magritte—dreamscapes, impossible juxtapositions, melting reality |
| **Expressionism** | Munch/Kirchner—emotional distortion, bold colors, psychological intensity |
...
| Style | Description |
|-------|-------------|
| **Moebius/Métal Hurlant** | Jean Giraud's surreal sci-fi comics—intricate linework, alien landscapes, dreamlike |
| **Tintin/Ligne Claire** | Hergé's clear-line style—flat colors, uniform line weight, European adventure |
| **Mike Mignola** | Hellboy's bold shadows, dramatic blacks, gothic horror comics |
...
| Style | Description |
|-------|-------------|
| **Polaroid Instant** | Square format, slightly faded, distinctive color cast, white borders |
| **1970s Giallo** | Italian horror film, saturated colors, dramatic lighting, baroque interiors |
| **David Lynch** | Surreal Americana, uncanny lighting, velvet curtains, dreamy unease |
| **Wong Kar-wai** | Neon-soaked Hong Kong, motion blur, romantic melancholy, step-printed frames |
| **Terrence Malick** | Magic hour cinematography, natural light, whispered voiceover landscapes |
| **Kubrick** | Symmetrical compositions, one-point perspective, cold precision, unsettling |
| **Vittorio Storaro** | Apocalypse Now/Last Emperor—dramatic color symbolism, painterly cinematography |
| **Roger Deakins** | Blade Runner 2049—atmospheric haze, silhouettes, environmental storytelling |
| **1950s Technicolor** | Saturated primary colors, glossy Hollywood glamour, studio-lit perfection |
| **French New Wave** | Godard/Truffaut—handheld intimacy, jump cuts, Parisian streets, playful |
...
| Style | Description |
|-------|-------------|
| **Stained Glass** | Medieval cathedral windows, lead lines, jewel-tone translucency, sacred light |
| **Woodcut Print** | Bold black relief prints, stark contrast, hand-carved texture, Dürer-style |
| **Mosaic** | Byzantine tesserae, fragmented tiles, gold backgrounds, sacred iconography |
| **Silhouette/Shadow Puppet** | Lotte Reiniger style, intricate cutout profiles, theatrical staging |
| **Cross-Stitch/Embroidery** | Pixel-adjacent textile art, folk patterns, domestic craft warmth |
| **Batik/Wax Resist** | Indonesian textile art, crackle patterns, earthy dyes, flowing organic forms |
| **Linocut** | Bold graphic prints, hand-cut texture, limited colors, folk art energy |
| **Collage/Mixed Media** | Hannah Höch—cut paper, layered textures, dadaist juxtaposition |
| **Fresco** | Michelangelo/Giotto—painted plaster, Renaissance religious scenes, ceiling art |
| **Chalkboard/Blackboard** | White and colored chalk on dark surface, educational nostalgia, hand-drawn |
...
| **Okami** | Japanese ink wash painting, sumi-e brushstrokes, celestial motifs |
| **Braid** | Painterly platformer, rich oil textures, dreamy time manipulation |
...
| Style | Description |
|-------|-------------|
| **Victorian Illustration** | Gustave Doré—detailed engravings, dramatic crosshatching, literary scenes |
| **1950s Advertising** | Norman Rockwell meets Madison Avenue—idealized Americana, warm nostalgia |
| **1960s Psychedelic** | Peter Max—swirling colors, op-art patterns, flower power, yellow submarine |
| **1970s Sci-Fi Paperback** | Chris Foss—impossible spacecraft, metallic surfaces, cosmic vistas |
| **1980s Airbrush** | Syd Mead—sleek futures, chrome reflections, neon grids, Blade Runner design |
| **1990s Grunge** | Photocopied zines, distressed textures, anti-corporate aesthetic |
| **Y2K Aesthetic** | Silver chrome, translucent plastics, optimistic tech, candy colors |
| **Vaporwave** | 80s nostalgia, glitch art, Greek statues, pink/cyan/purple, digital decay |
...
| Style | Description |
|-------|-------------|
| **Persian Miniature** | Intricate Islamic art, gold details, floral borders, stylized figures |
| **Aztec/Mayan Codex** | Pre-Columbian manuscript style, glyphs, bold outlines, ritual imagery |
| **Chinese Scroll Painting** | Shan shui landscape, negative space, mist-shrouded mountains, calligraphy |
| **Aboriginal Dot Painting** | Australian indigenous art, concentric patterns, earth pigments, dreamtime |
| **Mexican Muralism** | Diego Rivera—bold social realism, monumental scale, indigenous themes |
...
- Prioritize styles that translate well to first-person adventure game scenes
- Consider how NPCs will integrate with each style
- Some styles (like Obra Dinn's 1-bit) may need special handling
- Test new presets across multiple scene types before finalizing
