/**
 * DebugPanel - Displays LLM interaction details for debugging
 */
  ...
  return (
    <div className="bg-terminal-surface border border-terminal-border rounded-lg overflow-hidden">
      ...
      <button
        ...
        className="w-full flex items-center justify-between px-3 py-2 bg-terminal-bg/50 
                   border-b border-terminal-border hover:bg-terminal-bg/70 transition-colors"
      >
        <div className="flex items-center gap-2">
          <span className="text-terminal-warning text-xs">🔧</span>
          <span className="text-terminal-accent text-xs font-medium uppercase tracking-wider">
            LLM Debug
          </span>
        </div>
        <div className="flex items-center gap-2">
